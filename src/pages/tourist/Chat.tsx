        ...
        <div className={`flex-1 flex flex-col h-full ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50/50'} transition-colors duration-300`}>
          {activeChatId && activeConversation ? (
              ...
              <div className={`p-5 border-t transition-colors duration-300 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
                <form onSubmit={handleSendMessage} className="flex gap-3">
                  ...
                  <button
                    ...
                    className="bg-forest-600 text-white p-3 rounded-full hover:bg-forest-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg transform hover:scale-105 disabled:transform-none disabled:hover:scale-100"
                  >
                    <Send size={20} />
                  </button>
                </form>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-gray-400">
              ...
              <p className="text-sm">Choose a guide from the list or start a new conversation</p>
            </div>
          )}
        </div>
      </div>
